// v27 3オクターブ長音階 — 開始音は実用的なファースト〜サードポジ基準
...
const nextL = (L,step)=> LETTERS[(LETTERS.indexOf(L)+step+7)%7];

// 実用の開始音（Carl Flesch/小野アンナの並びに合わせ、主音から3オクターブ）
const START = {
