// app.js
// 442Hz厳密・YAMAHA系針サーボ・RMS閾値未満は無評価・二小節ページング・バックグラウンド即停止（許可要求もしない）・エラー下部
...
setInterval(()=>{ if ((document.visibilityState!=="visible" || !document.hasFocus()) && mediaStream){ suspendAll("watchdog"); } }, 1200);
